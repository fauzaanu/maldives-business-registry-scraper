...
class BusinessRegistryExtractor:
    ...
    def _extract_single_business(self, card: Selector, source_url: str, search_query: Optional[str]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_business_banner(self, selector: Selector) -> Dict[str, Any]:
        ...
        if number_text:
            ...
            registration_number = number_text[0].strip(' ∙')
...
class DatasetManager:
    ...
    @staticmethod
    async def save_to_named_dataset(context: HttpCrawlingContext, data: List[Dict[str, Any]], 
                                  dataset_name: str) -> None:
        """
        Save data to a named dataset.
        # Note: Crawlee Python doesn't have named datasets like Apify SDK
        # This is a placeholder for future implementation
        """
        await DatasetManager.save_businesses(context, data)
